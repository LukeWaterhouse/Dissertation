...
app.post('/NewProfile', (req, res) => {
  ...
  const profileInfo = new ProfileInfo({userName: userName, location: "placeholder", About: "placeholder", Tag1: "placeholder", Tag2: "placeholder", Tag3: "placeholder", Tag4: "placeholder" })
...
app.get('/ProfileInfo', (req, res) => {
  ...
  ProfileInfo.findOne({ userName }).then((profileInfo) => {
    if(profileInfo == null){
      ...
      //console.log("found")
      res.send({ location: profileInfo.location, About: profileInfo.About, Tag1: profileInfo.Tag1, Tag2: profileInfo.Tag2, Tag3: profileInfo.Tag3, Tag4:profileInfo.Tag4 })
    }
  })
})
...
app.put('/ProfileInfo', (req,res) => {
  ...
  let profileUpdate = ProfileInfo.findOneAndUpdate(filter, obj, {new: true}, (err, doc) => {
    if(err) {
